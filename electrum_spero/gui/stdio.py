...
from electrum_spero import WalletStorage, Wallet
...
from electrum_spero.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui:
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid SperoCoin address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-spero setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-spero setconfig' to change your settings")
        return True
