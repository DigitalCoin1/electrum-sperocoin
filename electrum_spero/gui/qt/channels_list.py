...
from electrum_spero.util import bh2u, NotEnoughFunds, NoDynamicFeeEstimates
from electrum_spero.i18n import _
from electrum_spero.lnchannel import AbstractChannel, PeerState, ChannelBackup, Channel, ChannelState
from electrum_spero.wallet import Abstract_Wallet
from electrum_spero.lnutil import LOCAL, REMOTE, format_short_channel_id, LN_MAX_FUNDING_SAT
from electrum_spero.lnworker import LNWallet
...
class ChannelsList(MyTreeView):
    ...
    def new_channel_dialog(self):
        ...
        if self.parent.network.channel_db:
            ...
            from electrum_spero.lnworker import hardcoded_trampoline_nodes
