...
from electrum_spero.util import UserCancelled, InvalidPassword, WalletFileException, get_new_wallet_name
from electrum_spero.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack, ReRunDialog
...
from electrum_spero.plugin import run_hook, Plugins
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config: 'SimpleConfig', app: QApplication, plugins: 'Plugins', *, gui_object: 'ElectrumGui'):
        ...
        self.setWindowTitle('SperoCoin Electrum  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon('electrum-spero.png')
        self.show()
        self.raise_()
    ...
    def select_storage(self, path, get_wallet_from_daemon) -> Tuple[str, Optional[WalletStorage]]:
        ...
        self.set_layout(vbox, title=_('SperoCoin Electrum Wallet'))
