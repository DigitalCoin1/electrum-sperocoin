...
import os
from electrum_spero.util import pkg_dir


sperocoin_stylesheet = """
...
QComboBox::down-arrow {
    border-image: url({pkg_dir}/gui/icons/spero_downArrow.png) 0 0 0 0 stretch stretch;
}
...
QAbstractSpinBox::up-arrow {
    image: url({pkg_dir}/gui/icons/spero_upArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::up-arrow:disabled, QAbstractSpinBox::up-arrow:off {
    image: url({pkg_dir}/gui/icons/spero_upArrow_small_disabled.png);
}

QAbstractSpinBox::down-arrow {
    image: url({pkg_dir}/gui/icons/spero_downArrow_small.png);
    width: 10px;
    height: 10px;
}

QAbstractSpinBox::down-arrow:disabled, QAbstractSpinBox::down-arrow:off {
    image: url({pkg_dir}/gui/icons/spero_downArrow_small_disabled.png);
}
...
QScrollBar:up-arrow {
    background-image: url({pkg_dir}/gui/icons/spero_upArrow_small.png);
}

QScrollBar:down-arrow {
    background-image: url({pkg_dir}/gui/icons/spero_downArrow_small.png);
}

QScrollBar:left-arrow {
    background-image: url({pkg_dir}/gui/icons/spero_leftArrow_small.png);
}

QScrollBar:right-arrow {
    background-image: url({pkg_dir}/gui/icons/spero_rightArrow_small.png);
}
...
sperocoin_stylesheet = sperocoin_stylesheet.replace('{pkg_dir}', '%s' % pkg_dir_for_css)
