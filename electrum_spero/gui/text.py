...
from electrum_spero.util import format_satoshis
from electrum_spero.bitcoin import is_address, COIN
from electrum_spero.transaction import PartialTxOutput
from electrum_spero.wallet import Wallet
from electrum_spero.wallet_db import WalletDB
from electrum_spero.storage import WalletStorage
from electrum_spero.network import NetworkParameters, TxBroadcastError, BestEffortRequestFailed
from electrum_spero.interface import ServerAddr
...
class ElectrumGui:
    ...
    def __init__(self, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        if not storage.file_exists():
            print("Wallet not found. try 'electrum-spero create'")
            exit()
