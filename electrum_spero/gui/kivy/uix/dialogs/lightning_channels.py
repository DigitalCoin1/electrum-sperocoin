...
from electrum_spero.util import bh2u
from electrum_spero.logging import Logger
from electrum_spero.lnutil import LOCAL, REMOTE, format_short_channel_id
from electrum_spero.lnchannel import AbstractChannel, Channel, ChannelState
from electrum_spero.gui.kivy.i18n import _
from electrum_spero.transaction import PartialTxOutput, Transaction
from electrum_spero.util import NotEnoughFunds, NoDynamicFeeEstimates, format_fee_satoshis, quantize_feerate
from electrum_spero.lnutil import ln_dummy_address
...
if TYPE_CHECKING:
    ...
    from electrum_spero import SimpleConfig
    ...
    BoxLayout:
        ...
        ScrollView:
            ...
            BoxLayout:
                ...
                BoxLabel:
                    text: _('Fee rate')
                    value: '{} spr/byte'.format(root.feerate)
                BoxLabel:
...
class SwapDialog(Factory.Popup):
    ...
    def update_fee_text(self):
        ...
        if eta > RECOMMEND_BLOCKS_SWAP or eta == -1:
            msg = f'Warning: Your fee rate of {fee_per_b} spr/B may be too ' \
            ...
            msg = f'Info: Your swap is estimated to be processed in {eta} ' \
                  f'block{s} with an onchain fee rate of {fee_per_b} spr/B.'

        self.fee_rate_text = f'{fee_per_b} spr/B'
