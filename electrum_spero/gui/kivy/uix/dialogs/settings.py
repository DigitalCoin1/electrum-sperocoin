...
from electrum_spero.util import base_units_list
from electrum_spero.i18n import languages
from electrum_spero.gui.kivy.i18n import _
from electrum_spero.plugin import run_hook
from electrum_spero import coinchooser
...
#:import _ electrum_spero.gui.kivy.i18n._
#:import messages electrum_spero.gui.messages
        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _("Base unit for SperoCoin amounts.")
