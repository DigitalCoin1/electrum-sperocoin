...
from electrum_spero.wallet_db import WalletDB
from electrum_spero.wallet import Wallet, InternalAddressCorruption, Abstract_Wallet
from electrum_spero.wallet import check_password_for_directory, update_password_for_directory

from electrum_spero.plugin import run_hook
from electrum_spero import util
from electrum_spero.util import (profiler, InvalidPassword, send_exception_to_crash_reporter,
                               format_satoshis, format_satoshis_plain, format_fee_satoshis,
                               maybe_extract_bolt11_invoice)
from electrum_spero.invoices import PR_PAID, PR_FAILED
from electrum_spero import blockchain
from electrum_spero.network import Network, TxBroadcastError, BestEffortRequestFailed
from electrum_spero.interface import PREFERRED_NETWORK_PROTOCOL, ServerAddr
from electrum_spero.logging import Logger
from electrum_spero.gui import messages
from .i18n import _
...
#Factory.register('InstallWizard', module='electrum_spero.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_spero.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_spero.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_spero.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_spero_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_spero.gui.kivy.uix.screens')
...
from electrum_spero.util import (NoDynamicFeeEstimates, NotEnoughFunds,
...
if TYPE_CHECKING:
    ...
    from electrum_spero.plugin import Plugins
    from electrum_spero.paymentrequest import PaymentRequest
...
class ElectrumWindow(App, Logger):
    ...
    def on_qr(self, data):
        from electrum_spero.bitcoin import is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_spero.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_spero.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_spero_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_spero_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = os.path.dirname(KIVY_GUI_PATH) + "/icons/electrum-spero.png"
    ...
    def get_max_amount(self):
        from electrum_spero.transaction import PartialTxOutput
    ...
    def format_fee_rate(self, fee_rate):
        ...
        return format_fee_satoshis(fee_rate/1000) + ' spr/byte'
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('electrum-spero', message,
                            app_icon=icon, app_name='electrum-spero')
        except ImportError:
