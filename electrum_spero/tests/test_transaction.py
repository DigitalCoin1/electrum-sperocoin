...
from electrum_spero import transaction, bitcoin
from electrum_spero.transaction import (convert_raw_tx_to_hex, tx_from_any, Transaction,
                                      PartialTransaction, TxOutpoint, PartialTxInput,
                                      PartialTxOutput)
from electrum_spero.util import bh2u, bfh
from electrum_spero.bitcoin import (deserialize_privkey, opcodes,
