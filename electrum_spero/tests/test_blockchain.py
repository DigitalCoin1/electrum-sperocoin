...
from electrum_spero import constants, blockchain
from electrum_spero.simple_config import SimpleConfig
from electrum_spero.blockchain import Blockchain, deserialize_header, hash_header
from electrum_spero.util import bh2u, bfh, make_dir
...
class TestVerifyHeader(ElectrumTestCase):
    ...
    # Data for SperoCoin block header #100.
