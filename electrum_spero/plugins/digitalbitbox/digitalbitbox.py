...
from electrum_spero.crypto import sha256d, EncodeAES_base64, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from electrum_spero.bitcoin import public_key_to_p2pkh
from electrum_spero.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from electrum_spero import ecc
from electrum_spero.ecc import msg_magic
from electrum_spero.wallet import Standard_Wallet
from electrum_spero import constants
from electrum_spero.transaction import Transaction, PartialTransaction, PartialTxInput
from electrum_spero.i18n import _
from electrum_spero.keystore import Hardware_KeyStore
from electrum_spero.util import to_string, UserCancelled, UserFacingException, bfh
from electrum_spero.base_wizard import ScriptTypeNotSupported, HWD_SETUP_NEW_WALLET
from electrum_spero.network import Network
from electrum_spero.logging import get_logger
from electrum_spero.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("SperoCoin Electrum-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
