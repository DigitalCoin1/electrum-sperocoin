...
from electrum_spero.util import make_dir, InvalidPassword, UserCancelled
from electrum_spero.gui.qt.util import (read_QIcon, EnterButton, WWLabel, icon_path,
                                      WindowModalDialog, Buttons, CloseButton, OkButton)
from electrum_spero.gui.qt.qrtextedit import ScanQRTextEdit
from electrum_spero.gui.qt.main_window import StatusBarButton
...
class Plugin(RevealerPlugin):
    ...
    def password_dialog(self, msg=None, parent=None):
        from electrum_spero.gui.qt.password_dialog import PasswordDialog
