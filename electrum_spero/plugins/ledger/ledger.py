...
from electrum_spero import ecc, constants
from electrum_spero import bip32
from electrum_spero.crypto import hash_160
from electrum_spero.bitcoin import int_to_hex, var_int, is_segwit_script_type, is_b58_address
from electrum_spero.bip32 import BIP32Node, convert_bip32_intpath_to_strpath
from electrum_spero.i18n import _
from electrum_spero.keystore import Hardware_KeyStore
from electrum_spero.transaction import Transaction, PartialTransaction, PartialTxInput, PartialTxOutput
from electrum_spero.wallet import Standard_Wallet
from electrum_spero.util import bfh, bh2u, versiontuple, UserFacingException
from electrum_spero.base_wizard import ScriptTypeNotSupported
from electrum_spero.logging import get_logger
from electrum_spero.plugin import runs_in_hwd_thread, Device
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "SperoCoin" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise UserFacingException(_("Device not in SperoCoin mode")) from e
                raise e
