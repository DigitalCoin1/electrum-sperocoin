...
from electrum_spero.util import UserCancelled, UserFacingException
from electrum_spero.keystore import bip39_normalize_passphrase
...
from electrum_spero.plugin import runs_in_hwd_thread
from electrum_spero.plugins.hw_wallet.plugin import OutdatedHwFirmwareException, HardwareClientBase
    ...
    def get_passphrase(self, available_on_device):
        if self.creating_wallet:
            msg = _("Enter a passphrase to generate this wallet.  Each time "
                    ...
                    "access the SperoCoins in the wallet.").format(self.device)
        else:
