...
from electrum_spero.transaction import Transaction
from electrum_spero import paymentrequest
from electrum_spero import paymentrequest_pb2 as pb2
from electrum_spero.bitcoin import address_to_script
