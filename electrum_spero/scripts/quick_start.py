...
from electrum_spero.wallet import Wallet, create_new_wallet
from electrum_spero.wallet_db import WalletDB
from electrum_spero.commands import Commands
from electrum_spero.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-spero/testnet as datadir
