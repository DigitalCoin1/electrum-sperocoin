...
```
$ adb -d install -r bin/electrum-spero-*-arm64-v8a-debug.apk
$ adb shell monkey -p org.electrum_spero.electrum_spero 1
```
...
```
adb logcat | grep -F "`adb shell ps | grep org.electrum_spero.electrum_spero | cut -c14-19`"
```
...
Run electrum with the `-g` switch: `electrum-spero -g kivy`
...
```
$ adb shell
$ run-as org.electrum_spero.electrum_spero ls /data/data/org.electrum_spero.electrum_spero/files/data
$ run-as org.electrum_spero.electrum_spero cp /data/data/org.electrum_spero.electrum_spero/files/data/wallets/my_wallet /sdcard/some_path/my_wallet
```
