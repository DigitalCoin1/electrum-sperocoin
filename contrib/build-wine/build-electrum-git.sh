...
pushd $WINEPREFIX/drive_c/electrum-spero
...
for i in ./locale/*; do
    dir="$WINEPREFIX/drive_c/electrum-spero/electrum_spero/$i/LC_MESSAGES"
    mkdir -p $dir
...
cd dist
mv electrum-spero-setup.exe $NAME_ROOT-$VERSION-setup.exe
cd ..
